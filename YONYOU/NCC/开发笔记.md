...
public class TestUFDouble {
    ...
    public static void main(String[] args){
        ...
        //精度控制
        UFDouble scaleValue1and1 = uf_value.setScale(1, 1);	//1234.5舍
        UFDouble scaleValue1and2 = uf_value.setScale(1, 2);	//1234.6入
        UFDouble scaleValue1and3 = uf_value.setScale(1, 3);	//1234.5
        UFDouble scaleValue1and4 = uf_value.setScale(1, 4);	//1234.6 四舍五入
